...
Ainda estão sendo realizados testes para identificar a causa das interrupções e verificar se o problema está relacionado à API, à conexão ou a algum outro fator externo.
